...
class DjangoHTMLTranslator(HTMLTranslator):
    ...
    version_text = {
        'deprecated': 'Deprecated in {{ cookiecutter.application_title }} %s',
        'versionchanged': 'Changed in {{ cookiecutter.application_title }} %s',
        'versionadded': 'New in {{ cookiecutter.application_title }} %s',
    }
